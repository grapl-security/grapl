...
class Node(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"asset_node",u"dynamic_node",u"file_node",u"ip_address_node",u"ip_port_node",u"network_connection_node",u"process_inbound_connection_node",u"process_node",u"process_outbound_connection_node",u"which_node"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"asset_node",u"dynamic_node",u"file_node",u"ip_address_node",u"ip_port_node",u"network_connection_node",u"process_inbound_connection_node",u"process_node",u"process_outbound_connection_node",u"which_node"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"asset_node",b"asset_node",u"dynamic_node",b"dynamic_node",u"file_node",b"file_node",u"ip_address_node",b"ip_address_node",u"ip_port_node",b"ip_port_node",u"network_connection_node",b"network_connection_node",u"process_inbound_connection_node",b"process_inbound_connection_node",u"process_node",b"process_node",u"process_outbound_connection_node",b"process_outbound_connection_node",u"which_node",b"which_node"]) -> builtin___bool: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"which_node",b"which_node"]) -> typing_extensions___Literal["asset_node","process_node","file_node","ip_address_node","process_outbound_connection_node","process_inbound_connection_node","ip_port_node","network_connection_node","dynamic_node"]: ...
...
class ProcessOutboundConnection(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"asset_id",u"created_timestamp",u"hostname",u"ip_address",u"last_seen_timestamp",u"node_key",u"port",u"state",u"terminated_timestamp"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"asset_id",b"asset_id",u"hostname",b"hostname"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"asset_id",b"asset_id",u"created_timestamp",b"created_timestamp",u"hostname",b"hostname",u"ip_address",b"ip_address",u"last_seen_timestamp",b"last_seen_timestamp",u"node_key",b"node_key",u"port",b"port",u"state",b"state",u"terminated_timestamp",b"terminated_timestamp"]) -> None: ...
