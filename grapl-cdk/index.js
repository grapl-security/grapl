...
class ModelPluginDeployer extends cdk.Stack {
    constructor(parent, name, jwt_secret, master_graph, engagement_graph, model_plugin_bucket, user_auth_table, vpc) {
        super(parent, name + '-stack');
        this.name = name + process.env.BUCKET_PREFIX;
        this.integrationName = name + process.env.BUCKET_PREFIX + 'Integration';
        this.event_handler = new lambda.Function(this, name, {
...
class Grapl extends cdk.App {
    constructor() {
        ...
        new AnalyzerExecutor(this, 'grapl-analyzer-executor', event_emitters.dispatched_analyzer_topic, event_emitters.analyzers_bucket, event_emitters.dispatched_analyzer_bucket, event_emitters.analyzer_matched_subgraphs_bucket, event_emitters.model_plugins_bucket, master_graph, network.grapl_vpc);
        ...
        new ModelPluginDeployer(this, 'model-plugin-deployer', jwtSecret, master_graph, engagement_graph, event_emitters.model_plugins_bucket, user_auth_table, network.grapl_vpc);
