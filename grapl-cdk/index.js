...
class HistoryDb extends cdk.Stack {
    constructor(parent, id, history_db_vpc_props, username, password) {
        super(parent, id + '-stack');
        const history_db_vpc = ec2.VpcNetwork.import(this, 'vpc', history_db_vpc_props);
...
class Grapl extends cdk.App {
    constructor(argv) {
        ...
        const history_db = new HistoryDb(this, 'history-db', network.history_db_vpc, new cdk.Token(process.env.HISTORY_DB_USERNAME), new cdk.Token(process.env.HISTORY_DB_PASSWORD));
        ...
        new NodeIdentifier(this, 'node-identifier', event_emitters.unid_subgraphs_generated_bucket, event_emitters.unid_subgraphs_generated_topic, event_emitters.subgraphs_generated_bucket, history_db.db, network.history_db_vpc);
        new GraphMerger(this, 'graph-merger', event_emitters.subgraphs_generated_bucket, event_emitters.subgraphs_generated_topic, event_emitters.subgraph_merged_topic, network.dgraph_vpc);
        new WordMacroAnalyzer(this, 'word-macro-analyzer', event_emitters.subgraph_merged_topic, event_emitters.incident_topic, network.dgraph_vpc);
        new EngagementCreationService(this, 'engagement-creation-service', event_emitters.incident_topic, network.dgraph_vpc);
    }
}
