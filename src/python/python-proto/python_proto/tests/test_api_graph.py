...
def test_identifed_edge_list_encode_decode() -> None:
    check_encode_decode_invariant(identified_edge_lists())


def test_identified_edge_encode_decode() -> None:
    check_encode_decode_invariant(identified_edges())
