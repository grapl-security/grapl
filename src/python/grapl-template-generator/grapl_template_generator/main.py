...
from grapl_template_generator.python_http_service.create_python_http_service import create_python_http_service
from grapl_template_generator.python_http_service.create_python_http_service_args import CreatePythonHttpServiceArgs
from grapl_template_generator.rust_grpc_service.create_rust_grpc_service import create_rust_grpc_service
...
def generate_python_http_server(
        project_name: str,
