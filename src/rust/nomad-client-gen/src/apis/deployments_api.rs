...
pub trait DeploymentsApi {
    ...
    fn post_deployment_pause(&self, deployment_id: &str, deployment_pause_request: crate::models::DeploymentPauseRequest, region: Option<&str>, namespace: Option<&str>, x_nomad_token: Option<&str>, idempotency_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::DeploymentUpdateResponse, Error>>>>;
    fn post_deployment_promote(&self, deployment_id: &str, deployment_promote_request: crate::models::DeploymentPromoteRequest, region: Option<&str>, namespace: Option<&str>, x_nomad_token: Option<&str>, idempotency_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::DeploymentUpdateResponse, Error>>>>;
    fn post_deployment_unblock(&self, deployment_id: &str, deployment_unblock_request: crate::models::DeploymentUnblockRequest, region: Option<&str>, namespace: Option<&str>, x_nomad_token: Option<&str>, idempotency_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::DeploymentUpdateResponse, Error>>>>;
}
