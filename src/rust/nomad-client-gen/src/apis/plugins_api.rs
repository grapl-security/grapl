    ...
    C: Clone + std::marker::Send + Sync,
{
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> PluginsApiClient<C> {
        PluginsApiClient { configuration }
    }
}
...
pub trait PluginsApi {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<Vec<crate::models::CsiPlugin>, Error>>>>;
    fn get_plugins(
        &self,
        region: Option<&str>,
        namespace: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<Vec<crate::models::CsiPluginListStub>, Error>>>>;
}
