    ...
    C: Clone + std::marker::Send + Sync,
{
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> EnterpriseApiClient<C> {
        EnterpriseApiClient { configuration }
    }
}

pub trait EnterpriseApi {
    fn create_quota_spec(
        &self,
    ...
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::QuotaSpec, Error>>>>;
    fn get_quotas(
        &self,
        region: Option<&str>,
        namespace: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<Vec<serde_json::Value>, Error>>>>;
    fn post_quota_spec(
        &self,
        spec_name: &str,
        quota_spec: crate::models::QuotaSpec,
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    fn get_quota_spec(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::GET, "/quota/{specName}".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
    ...
    fn post_quota_spec(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::POST, "/quota/{specName}".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
