    ...
    C: Clone + std::marker::Send + Sync,
{
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> EvaluationsApiClient<C> {
        EvaluationsApiClient { configuration }
    }
}
...
pub trait EvaluationsApi {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::Evaluation, Error>>>>;
    fn get_evaluation_allocations(
        &self,
        eval_id: &str,
        region: Option<&str>,
        namespace: Option<&str>,
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    fn get_evaluation_allocations(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/evaluation/{evalID}/allocations".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn get_evaluations(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::GET, "/evaluations".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
