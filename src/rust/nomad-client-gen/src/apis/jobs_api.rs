...
pub trait JobsApi {
    fn delete_job(
        ...
        purge: Option<bool>,
        global: Option<bool>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobDeregisterResponse, Error>>>>;
    fn get_job(
        &self,
        job_name: &str,
        region: Option<&str>,
    ...
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::Job, Error>>>>;
    ...
    fn get_job_evaluations(
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<Vec<crate::models::Evaluation>, Error>>>>;
    fn get_job_scale_status(
        &self,
        job_name: &str,
        region: Option<&str>,
        namespace: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobScaleStatusResponse, Error>>>>;
    fn get_job_summary(
        &self,
        job_name: &str,
        region: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobSummary, Error>>>>;
    fn get_job_versions(
        &self,
        job_name: &str,
        region: Option<&str>,
        ...
        next_token: Option<&str>,
        diffs: Option<bool>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobVersionsResponse, Error>>>>;
    fn get_jobs(
        &self,
        region: Option<&str>,
        namespace: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<Vec<crate::models::JobListStub>, Error>>>>;
    fn post_job(
        &self,
        job_name: &str,
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobRegisterResponse, Error>>>>;
    fn post_job_dispatch(
        &self,
        job_name: &str,
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobDispatchResponse, Error>>>>;
    fn post_job_evaluate(
        &self,
        job_name: &str,
    ...
    fn post_job_periodic_force(
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::PeriodicForceResponse, Error>>>>;
    fn post_job_plan(
        &self,
        job_name: &str,
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobPlanResponse, Error>>>>;
    fn post_job_revert(
        &self,
        job_name: &str,
    ...
    fn post_job_stability(
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobStabilityResponse, Error>>>>;
    fn post_job_validate_request(
        &self,
        ...
        x_nomad_token: Option<&str>,
        idempotency_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::JobValidateResponse, Error>>>>;
    fn register_job(
        &self,
        job_register_request: crate::models::JobRegisterRequest,
        region: Option<&str>,
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    fn delete_job(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::DELETE, "/job/{jobName}".to_string())
    ...
    fn get_job(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::GET, "/job/{jobName}".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
    ...
    fn get_job_allocations(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/job/{jobName}/allocations".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn get_job_deployment(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/job/{jobName}/deployment".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn get_job_deployments(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/job/{jobName}/deployments".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn get_job_evaluations(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/job/{jobName}/evaluations".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn get_job_versions(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/job/{jobName}/versions".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn post_job(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::POST, "/job/{jobName}".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
    ...
    fn post_job_dispatch(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::POST,
            "/job/{jobName}/dispatch".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn post_job_evaluate(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::POST,
            "/job/{jobName}/evaluate".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn post_job_parse(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::POST, "/jobs/parse".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
    ...
    fn post_job_periodic_force(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::POST,
            "/job/{jobName}/periodic/force".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
    ...
    fn post_job_validate_request(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::POST, "/validate/job".to_string())
                .with_auth(__internal_request::Auth::ApiKey(
                    __internal_request::ApiKey {
                        in_header: true,
                        in_query: false,
