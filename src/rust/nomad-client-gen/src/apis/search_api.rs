...
pub trait SearchApi {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::FuzzySearchResponse, Error>>>>;
    fn get_search(
        &self,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::SearchResponse, Error>>>>;
}
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    fn get_fuzzy_search(
        ...
        let mut req =
            __internal_request::Request::new(hyper::Method::POST, "/search/fuzzy".to_string())
