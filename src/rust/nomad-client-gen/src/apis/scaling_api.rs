    ...
    C: Clone + std::marker::Send + Sync,
{
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ScalingApiClient<C> {
        ScalingApiClient { configuration }
    }
}

pub trait ScalingApi {
    fn get_scaling_policies(
        &self,
        region: Option<&str>,
    ...
    ) -> Pin<Box<dyn Future<Output = Result<Vec<crate::models::ScalingPolicyListStub>, Error>>>>;
    fn get_scaling_policy(
        &self,
        policy_id: &str,
        region: Option<&str>,
        namespace: Option<&str>,
        ...
        per_page: Option<i32>,
        next_token: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<crate::models::ScalingPolicy, Error>>>>;
}
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    {
        let mut req =
            __internal_request::Request::new(hyper::Method::GET, "/scaling/policies".to_string())
    ...
    fn get_scaling_policy(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/scaling/policy/{policyID}".to_string(),
        )
        .with_auth(__internal_request::Auth::ApiKey(
            __internal_request::ApiKey {
                in_header: true,
