...
use rust_proto::plugin_work_queue::plugin_work_queue_service_client::PluginWorkQueueServiceClient as _PluginWorkQueueServiceClient;
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
{
    ...
    pub async fn put_execute_generator(
        ...
        self.inner.put_execute_generator(_PutExecuteGeneratorRequest::from(request))
            .await
            .expect("todo");
        todo!()
    }
    ...
    pub async fn put_execute_analyzer(
        ...
        self.inner.put_execute_analyzer(_PutExecuteAnalyzerRequest::from(request))
            .await
            .expect("todo");
        todo!()
    }
    ...
    pub async fn get_execute_generator(
        ...
        self.inner.get_execute_generator(_GetExecuteGeneratorRequest::from(request))
            .await
            .expect("todo");
        todo!()
    }
    ...
    pub async fn get_execute_analyzer(
        ...
        self.inner.get_execute_analyzer(_GetExecuteAnalyzerRequest::from(request))
            .await
            .expect("todo");
        todo!()
    }
    ...
    pub async fn acknowledge(
        ...
        self.inner.acknowledge(_AcknowledgeRequest::from(request))
            .await
            .expect("todo");
        todo!()
    }
