...
/// Creates a subgraphdescribing an inbound `NetworkEvent`
///
/// The subgraphgenerated is similar to the graph generated by [super::generate_outbound_connection_subgraph]
