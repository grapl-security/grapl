...
use rusoto_s3::{
    ListObjectsV2Output,
    ListObjectsV2Request as InnerListObjectsV2Request,
    Object,
};
...
impl<S, const READ_CAP: bool, const WRITE_CAP: bool> ListS3<S, READ_CAP, WRITE_CAP>
    for Bucket<S, READ_CAP, WRITE_CAP, true>
where
    S: S3Common,
{
    fn list_objects(&self) -> ListObjectRequest<S, READ_CAP, WRITE_CAP> {
    ...
    S: S3Common,
{
    ...
    ) -> Result<ListObjectsV2Output, TmpError> {
        let response = self
            .bucket
            .s3_client
            .s3_client
            .list_objects_v2(InnerListObjectsV2Request {
