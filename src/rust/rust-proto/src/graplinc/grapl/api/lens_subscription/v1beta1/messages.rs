...
impl type_url::TypeUrl for NodeAddedToLensScope {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.lens_subscription.v1beta1.NodeAddedToLensScope";
}
...
impl type_url::TypeUrl for NodeRemovedFromLensScope {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.lens_subscription.v1beta1.NodeRemovedFromLensScope";
}
...
impl type_url::TypeUrl for SubscribeToLensResponse {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.lens_subscription.v1beta1.SubscribeToLensResponse";
}
