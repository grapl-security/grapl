...
impl type_url::TypeUrl for CreateEventSourceRequest {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.CreateEventSourceRequest";
}
...
impl type_url::TypeUrl for CreateEventSourceResponse {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.CreateEventSourceResponse";
}
...
impl type_url::TypeUrl for UpdateEventSourceRequest {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.UpdateEventSourceRequest";
}
...
impl type_url::TypeUrl for UpdateEventSourceResponse {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.UpdateEventSourceResponse";
}
...
impl type_url::TypeUrl for GetEventSourceRequest {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.GetEventSourceRequest";
}
...
impl From<GetEventSourceRequest> for proto::GetEventSourceRequest {
    fn from(value: GetEventSourceRequest) -> Self {
        Self {
            event_source_id: Some(value.event_source_id.into()),
        }
    }
...
impl type_url::TypeUrl for EventSource {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.EventSource";
}
...
impl type_url::TypeUrl for GetEventSourceResponse {
    const TYPE_URL: &'static str =
        "graplsecurity.com/graplinc.grapl.api.event_source.v1beta1.GetEventSourceResponse";
}
