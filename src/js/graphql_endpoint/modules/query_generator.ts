import { GraphQLField, GraphQLList, GraphQLObjectType, GraphQLUnionType } from "graphql";
...
export class QueryGenerator {
  ...
  genField(args: {
    ...
    } else if (type instanceof GraphQLList && type.ofType instanceof GraphQLObjectType) {
...
${spaces}}`,
  ...
  genOnFragment(args: { type: GraphQLObjectType; numSpaces: number }): string {
