...
class ProcessDescription(google___protobuf___message___Message):
    ...
    @property
    def user_id(self) -> google___protobuf___wrappers_pb2___UInt64Value: ...

    @property
    def auid(self) -> google___protobuf___wrappers_pb2___UInt64Value: ...
    ...
    def __init__(self,
        *,
        ...
        operating_system : typing___Optional[typing___Text] = None,
        user_id : typing___Optional[google___protobuf___wrappers_pb2___UInt64Value] = None,
        auid : typing___Optional[google___protobuf___wrappers_pb2___UInt64Value] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"asset_id",u"auid",u"host_ip",u"hostname",u"user_id"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"asset_id",u"auid",u"created_timestamp",u"host_ip",u"hostname",u"last_seen_timestamp",u"node_key",u"operating_system",u"process_command_line",u"process_guid",u"process_id",u"process_integrity_level",u"process_name",u"state",u"terminated_timestamp",u"user_id"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"asset_id",b"asset_id",u"auid",b"auid",u"host_ip",b"host_ip",u"hostname",b"hostname",u"user_id",b"user_id"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"asset_id",b"asset_id",u"auid",b"auid",u"created_timestamp",b"created_timestamp",u"host_ip",b"host_ip",u"hostname",b"hostname",u"last_seen_timestamp",b"last_seen_timestamp",u"node_key",b"node_key",u"operating_system",b"operating_system",u"process_command_line",b"process_command_line",u"process_guid",b"process_guid",u"process_id",b"process_id",u"process_integrity_level",b"process_integrity_level",u"process_name",b"process_name",u"state",b"state",u"terminated_timestamp",b"terminated_timestamp",u"user_id",b"user_id"]) -> None: ...
