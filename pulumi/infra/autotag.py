# Until https://github.com/pulumi/pulumi-aws/issues/1134 is addressed,
# we're pulling in the code from
# https://github.com/joeduffy/aws-tags-example/tree/master/autotag-py
# to implement auto-tagging.
#
# See
...
def auto_tag(
    ...
    if is_taggable(args.type_):
        ...
        # write (see note above)
        args.props["tags"] = {**(args.props["tags"] or {}), **auto_tags}  # type: ignore[index, list-item]
